...
<br>
  <div class="form">
    <form class="login-form" action="verifikasiresetpass2.php" method="post">
      <input type="text" placeholder="Masukkan Kode Konfirmasi" required="" id="username"  name="verifikasi_text" />
